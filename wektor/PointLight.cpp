...
//}
//PointLight::PointLight(Vector location, float constAtten, float linearAtten, Intensity kolor) : location(
//        location), constAtten(constAtten), linearAtten(linearAtten), kolor(kolor) {}

PointLight::PointLight(Vector location, float constAtten, float linearAtten, Intensity color) {
